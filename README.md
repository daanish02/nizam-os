...
Agents communicate with services (finance, CRM, knowledge, etc.) via MCP. All LLM calls route through a local LiteLLM proxy to OpenRouter, so models are plug-and-play.
